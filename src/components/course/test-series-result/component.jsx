...
export default class TestSeriesResultComponent extends React.Component{
    state ={
     isError:false,
    ...
    render(){
     ...
     if(this.state.testAttempt 
      ...
      return (
       <div className="container-flux test-series-result-container">
        <div className="row heading-row justify-content-center">
         <span className="heading-text">TEST RESULT for {this.state.testSeries.name} </span>
        </div>
      ...
      return (<div className="test-series-result-container">
       {this.state.message}
      </div>);
     }
