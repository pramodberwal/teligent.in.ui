...
class TestSeriesQuestionTableBodyRow extends React.Component{
    state = {
     question:'',
     choiceName:''
    } 
     ...
     return (question?<tr>
      ...
      <td>
       <button className="btn btn-danger"      
        onClick={()=>this.props.onQuestionRemove(this.props.seriesId,question.id)}
       >Remove</button></td>
...
let TestSeriesQuestionTableHeader =()=>{
 return (
  <tr>
   <th>ID</th>   
   <th>Description</th>   
